/*
  Proposta: Crie uma classe LinguagemFavorita que possua os atributos nome, anoDeCriacao e IDE. Em seguida, crie um
            ...
            Ao final, exiba as linguagens no console, uma em baixo da outra.

            Esse é o mesmo exercício feito na aula de ordenação.
*/

import java.util.*;

public class exPropSet02 {
